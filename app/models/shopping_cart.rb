...
scope :bought_months_postgres, -> { bought_carts.order("updated_at DESC").group("DATE_TRUNC('month', updated_at + interval '9 hour'), updated_at").pluck(:updated_at) }
scope :bought_days_postgres, -> { bought_carts.order("updated_at DESC").group("DATE(updated_at + interval '9 hour'), updated_at").pluck(:updated_at) }
scope :bought_months_postgres, -> { bought_carts.order("updated_at DESC").group("DATE_TRUNC('month', updated_at + interval '9 hour'), updated_at").pluck(:updated_at) }
scope :bought_days_postgres, -> { bought_carts.order("updated_at DESC").group("DATE(updated_at + interval '9 hour'), updated_at").pluck(:updated_at) }
